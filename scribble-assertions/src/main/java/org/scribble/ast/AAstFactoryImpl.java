...
import org.scribble.del.global.AGChoiceDel;
...
import org.scribble.del.global.AGInteractionSeqDel;
import org.scribble.del.global.AGMessageTransferDel;
import org.scribble.del.global.AGProtocolBlockDel;
...
import org.scribble.del.name.AAmbigNameNodeDel;
...
public class AAstFactoryImpl implements AAstFactory
{
	...
	@Override
	public <K extends PayloadTypeKind> AAnnotPayloadElem<K> AnnotPayloadElem(CommonTree source, 
	...
	public GProtocolBlock GProtocolBlock(CommonTree source, GInteractionSeq seq)
	{
		...
		gpb = del(gpb, new AGProtocolBlockDel());
		return gpb;
	}
	...
	public GInteractionSeq GInteractionSeq(CommonTree source, List<GInteractionNode> actions)
	{
		...
		gis = del(gis, new AGInteractionSeqDel());
		return gis;
	}
	...
	public AmbigNameNode AmbiguousNameNode(CommonTree source, String identifier)
	{
		...
		ann = (AmbigNameNode) ann.del(new AAmbigNameNodeDel());
		return ann;
	}
	...
	private AScribDel createDefaultDelegate()
	{
	...
	// FIXME: factor out
	//@SuppressWarnings("unchecked")
	private static <T extends ScribNodeBase> T del(T n, AScribDel del)
	{
