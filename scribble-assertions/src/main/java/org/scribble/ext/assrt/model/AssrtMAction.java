 ...
 * the License.
 */
package org.scribble.ext.assrt.model;
...
@Deprecated
public abstract class AssrtMAction<K extends ProtocolKind> extends MAction<K>
{
	public final AssrtAssertionNode assertion; 
	
	protected AssrtMAction(Role obj, MessageId<?> mid, Payload payload)
	{
		this(obj, mid, payload, null); 
	}
	
	protected AssrtMAction(Role obj, MessageId<?> mid, Payload payload, AssrtAssertionNode assertion)
	{
	...
	public boolean equals(Object o)  // FIXME: kind
	{
		...
		if (!(o instanceof AssrtMAction))
		{
			return false;
		}
		AssrtMAction<?> a = (AssrtMAction<?>) o;  // Refactor as "compatible"
