...
@Deprecated
public abstract class AssrtSAction extends AssrtMAction<Global>
{
	public final Role subj;

	public AssrtSAction(Role subj, Role obj, MessageId<?> mid, Payload payload, AssrtAssertionNode assertion)
	{
	...
	public boolean equals(Object o)  // FIXME: kind
	{
		...
		if (!(o instanceof AssrtSAction))
		{
			return false;
		}
		AssrtSAction a = (AssrtSAction) o;
	...
	{
		return o instanceof AssrtSAction;
	}
}
