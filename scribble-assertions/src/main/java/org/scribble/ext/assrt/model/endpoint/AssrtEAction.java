...
import org.scribble.ext.assrt.model.AssrtMAction;
...
@Deprecated
public abstract class AssrtEAction extends AssrtMAction<Local>
{
	...
	protected AssrtEAction(Role peer, MessageId<?> mid, Payload payload)
	{
		this(peer, mid, payload, null); 
	}
	
	protected AssrtEAction(Role peer, MessageId<?> mid, Payload payload, AssrtAssertionNode assertion)
	{
		/*this.mid = mid;
	...
	public abstract AssrtEAction toDual(Role self);
