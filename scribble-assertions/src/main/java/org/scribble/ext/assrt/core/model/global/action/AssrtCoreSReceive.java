...
public class AssrtCoreSReceive extends AssrtSReceive implements AssrtCoreSAction
{
	...
	public AssrtCoreSReceive(Role subj, Role obj, MessageId<?> mid, Payload payload, AssrtBoolFormula bf,
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AssrtCoreSReceive))
		{
			return false;
		}
		AssrtCoreSReceive as = (AssrtCoreSReceive) o;
	...
	{
		return o instanceof AssrtCoreSReceive;
	}
}
