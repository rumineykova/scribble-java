...
public class OfferTypeBuilder implements IRustMpstBuilder {
	...
	public OfferTypeBuilder(ArrayList<IRustMpstBuilder> paths, BuilderKind kind, Role self, Role controlRole) {
		this.paths = paths;
		this.kind = kind;
		this.self = self;
	...
	// type OfferA<N> =OfferMpst<AtoBVideo<N>, AtoCVideo<N>, AtoBClose, AtoCClose,
	// QueueAVideo, QueueAEnd>;
	...
	@Override
	public String build() {
		return this.buildMpstOffer() + this.buildMpstChoice();
	}
